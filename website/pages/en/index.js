    ...
    return (
      <SplashContainer>
        <div className="inner">
          <ProjectTitle />
          <PromoSection>
            <Button href={docUrl('try_emuto', language)}>Try it out</Button>
            <Button href={docUrl('tutorial', language)}>Get started</Button>
...
const Features = () => (
  <Block layout="twoColumn">
    {[
      {
        title: 'Transform and query data structures',
        content:
          'Restructure, transform, and manipulate data structures effortlessly'
      },
      {
        title: 'Supports multiple file formats',
        content: 'plain text, JSON, csv, tsv, dsv'
      },
      {
        title: 'Inspired by jq and GraphQL',
        content:
          '[Compare emuto to jq and GraphQL](/emuto/docs/comparison_with_other_languages)'
      },
      {
